...
mod phase_1_type_variables {
    use moonlane::typeinference::{TypeVar, TypeVarGenerator};
...
mod phase_2_infer_types {
    use moonlane::typeinference::{InferType, TypeVar};
    use moonlane::types::Type;
...
mod phase_3_substitution {
    use moonlane::typeinference::{InferType, Substitution, TypeVar};
...
mod phase_4_unification {
    use moonlane::typeinference::{unify, InferType, TypeVar};
...
mod phase_5_constraints {
    use moonlane::typeinference::{solve_constraints, Constraint, InferType, TypeVar};
    use moonlane::ast::Span;
...
mod phase_7_infer_context {
    use moonlane::ast::Span;
    use moonlane::typeinference::{generalize, InferContext, InferType, TypeScheme, TypeVar};
    use std::collections::HashSet;
...
mod phase_8_known_limitations {
    ...
    /// limit_03_field_access_needs_annotation.mln. At the constraint level,
    ...
    fn test_eager_partial_solve_var_has_no_named_type() {
        ...
        use moonlane::typeinference::Substitution;
